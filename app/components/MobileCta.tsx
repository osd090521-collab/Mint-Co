...
export function MobileCta() {
  ...
  return (
    <div
      ...
      className={`fixed inset-x-0 bottom-0 z-40 border-t border-line bg-bg/95 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3 backdrop-blur-md transition-all duration-[var(--dur-element)] ease-[var(--ease-house)] sm:hidden ${
        visible
